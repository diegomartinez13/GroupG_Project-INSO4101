...
@app.route("/tittle/<int:post_id>", methdos=['GET', 'POST'])
...
@app.route("/content/<int:post_id>", methdos=['GET', 'POST'])
...
@app.route("/created_at/<int:post_id>", methdos=['GET'])
...
@app.route("/parent_post_id/<int:post_id>", methdos=['GET', 'POST'])
